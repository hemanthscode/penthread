...
const AuthorAnalytics = () => {
  ...
  return (
    <Container className="py-8">
      <PageHeader title="My Analytics" description="Track your content performance and engagement" icon={BarChart3} />
      ...
      {/* Performance Metrics / Recent Activity Cards */}
      {/* You can add bars and charts similar to AdminAnalytics here */}
    </Container>
  );
};
